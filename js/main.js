...
async function submitForm() {
    ...
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbweXc7yN5kePOz_AupnQYXlPbito70plLmeJmEDelJF8U_5gx3tlfc2B0hT-0irfDeU/exec', { // Replace with your Google Apps Script URL
            method: 'POST',
            headers: {
